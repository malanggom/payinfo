      ...
      <div class="modal-content">
        <div class="modal-header d-flex align-items-center">
          <div class="flex-grow-1 text-center">
            <h1 class="modal-title fs-4" id="staticBackdropLabel">프로젝트 추가</h1>
          </div>
                ...
                <div class="col-10 d-flex align-items-center form-status-bg">
                  <div class="d-flex justify-content-between form-control form-status toggleTextWrap" @click="indvInfoHandleClick">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="form-status-button" :class="{completed: indvInfoInputStatus === '입력완료', default: indvInfoInputStatus !== '입력완료'}">
                        {{ indvInfoInputStatus }}
                      </div>
              ...
              <div class="d-flex justify-content-center">
                <div class="col-10 d-flex align-items-center form-status-bg">
                  <div class="d-flex justify-content-between form-control form-status toggleTextWrap" @click="ctrtSttsHandleClick">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="form-status-button" :class="{completed: ctrtSttsInputStatus === '입력완료', default: ctrtSttsInputStatus !== '입력완료'}">
                        {{ ctrtSttsInputStatus }}
                      </div>
              ...
              <div class="d-flex justify-content-center">
                <div class="col-10 d-flex align-items-center form-status-bg">
                  <div class="d-flex justify-content-between form-control form-status toggleTextWrap" @click="hldTechHandleClick">
                    ...
                    <div class="d-flex align-items-center">
                      <div class="form-status-button" :class="{completed: hldTechInputStatus === '입력완료', default: hldTechInputStatus !== '입력완료'}">
                        {{ hldTechInputStatus }}
                      </div>
...
const ctrtSttsInputStatus = ref('입력중'); // 초기 상태
...
const submitForm = async (event) => {
  ...
  try {
    ...
    pjEventbus.SearchPjResultEvent.refreshData(); // 이벤트 발생
...
onMounted(async () => {
  pjEventbus.SearchPjResultEvent.add('pjOpenModal', pjOpenModalHandler); // 모달 열기 이벤트 등록
...
onUnmounted(() => {
  pjEventbus.SearchPjResultEvent.remove('pjOpenModal', pjOpenModalHandler); // 모달 열기 이벤트 제거
});
</script>
